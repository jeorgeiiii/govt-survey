...
import 'unemployment_screen.dart'; // Import the previous screen
...
class _DisputesScreenState extends State<DisputesScreen> {
  ...
  void _goToPreviousScreen() {
    // Navigate back to UnemploymentScreen
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Icon(Icons.arrow_back, color: Colors.blue.shade800, size: 18),
                                  SizedBox(width: 8),
                                  Text(
                                    'Previous: Unemployment Data',
                                    style: TextStyle(
                                      fontSize: 13,
                              ...
                              Row(
                                children: [
                                  Icon(Icons.navigate_next, color: Colors.green.shade700, size: 18),
                                  SizedBox(width: 8),
                                  Text(
                                    'Next: Social Consciousness',
                                    style: TextStyle(
                                      fontSize: 13,
