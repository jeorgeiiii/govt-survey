      ...
      children: [
        ...
        if (_hasApproachRoads || _hasInternalLanes)
          SummaryCard(
            ...
            items: [
              if (_hasApproachRoads) {'label': 'Approach Roads:', 'value': 'Available'},
              if (_hasApproachRoads && _numApproachRoads.isNotEmpty) {'label': '  • Number:', 'value': _numApproachRoads},
              if (_hasApproachRoads && _approachCondition.isNotEmpty) {'label': '  • Condition:', 'value': _approachCondition},
              if (_hasApproachRoads && _approachRemarks.isNotEmpty) {'label': '  • Remarks:', 'value': _approachRemarks},
              if (_hasInternalLanes) {'label': 'Internal Lanes:', 'value': 'Available'},
              if (_hasInternalLanes && _numInternalLanes.isNotEmpty) {'label': '  • Number:', 'value': _numInternalLanes},
              if (_hasInternalLanes && _internalCondition.isNotEmpty) {'label': '  • Condition:', 'value': _internalCondition},
              if (_hasInternalLanes && _internalRemarks.isNotEmpty) {'label': '  • Remarks:', 'value': _internalRemarks},
            ],
          ),
      ],
    );
