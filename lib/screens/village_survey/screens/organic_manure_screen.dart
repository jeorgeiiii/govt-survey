...
class _OrganicManureScreenState extends State<OrganicManureScreen> {
  ...
  void _showSuccessDialog() {
    double fully = double.tryParse(_fullyController.text) ?? 0;
    double partially = double.tryParse(_partiallyController.text) ?? 0;
    double total = fully + partially;
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text('Continue to Seed Clubs?'),
            SizedBox(height: 10),
            Text('Families: ${_familiesController.text}'),
            Text('Fully: ${fully.toStringAsFixed(1)} acres'),
            Text('Partially: ${partially.toStringAsFixed(1)} acres'),
            Text('Total: ${total.toStringAsFixed(1)} acres',
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            SizedBox(width: 5),
                            Text('Previous: Panchavati Trees', 
